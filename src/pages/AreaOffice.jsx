          ...
          <div className="row">
            <div className="col-lg-8">
              <div className="department-content mt-5">
                ...
                <p>Comercializamos um vasto leque de consumíveis e oferecemos soluções "chave na mão" para o apetrechamento de salas para escritório.</p>
              </div>
            </div>
            <div className="col-lg-4">
              <img src="/images/ramos/office.png" style={{ borderRadius: '5px' }} alt="" />
            </div>
          </div>
        </div>
      </section>
