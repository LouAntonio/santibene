          ...
          <div className="row">
            <div className="col-md-12">
              <div className="block text-center">
                <span className="text-white">Farmacêutica e Material Hospitalar</span>
                <BreadcrumbNav items={[
                  { to: '/', label: 'Home' },
          ...
          <div className="row">
            <div className="col-lg-8">
              <div className="department-content mt-5">
                ...
                <p>Com presença em angola, comercializamos a principais marcas de medicamentos, equipamentos e consumíveis na área da Saúde.</p>
              </div>
            </div>
            <div className="col-lg-4">
              <img src="/images/ramos/farmaceutica.png" style={{ borderRadius: '5px' }} alt="" />
            </div>
          </div>
        </div>
      </section>
